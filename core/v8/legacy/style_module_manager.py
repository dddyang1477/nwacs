...
- 描写精准但不冗长""",
            ...
            StyleModule(
                module_id="style_cinematic",
                name="影视感镜头",
                category=StyleCategory.HOT_BLOODED,
                description="用镜头语言写作，画面感极强，每个场景都能被拍摄，适合全类型",
                system_prompt="""你是一位精通影视化写作的顶级作家。请以影视感镜头风格写作：

【镜头意识】
- 远景建立空间：每个新场景先用远景交代环境全貌
- 中景推进叙事：人物互动和情节推进用中景
- 特写引爆情绪：关键时刻切特写，聚焦一个细节放大情绪
- 慢镜头放大瞬间：生死关头把一秒掰成十秒写
- 主观镜头增强代入：切换到角色视角，所见即所感
...
- 反应用动作写，不用形容词写""",
                ...
                vocabulary_bias={
                    "镜头": 0.8, "画面": 0.8, "光影": 0.7, "色彩": 0.6,
                    "远景": 0.5, "特写": 0.7, "感官": 0.6, "节奏": 0.5,
                    "视觉": 0.7, "听觉": 0.6, "触觉": 0.5, "动作": 0.7,
                },
                sentence_patterns=["远景建立", "中景推进", "特写引爆", "慢镜头放大", "感官交响"],
                forbidden_patterns=["他感到", "他觉得", "他心想", "本章结束", "未完待续"],
                example_text="大殿的穹顶高得仿佛没有尽头。七十二根盘龙柱如巨人的肋骨撑起整片空间。林晨站在门口，身影被拉成一道细长的墨痕——在这庞然巨物面前，他渺小得像一粒尘埃。镜头推近——他的指尖。指甲深深掐进掌心，指节泛白。",
