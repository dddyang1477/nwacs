import type { SensitivityFilterParams, SensitivityReport } from '../types/index.js';

export async function filterSensitivity(params: SensitivityFilterParams): Promise<SensitivityReport> {
  try {
    ...
    const sensitive_content: string[] = [];
