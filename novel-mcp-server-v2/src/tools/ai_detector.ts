import type { AIDetectionParams, AIDetectionResult } from '../types/index.js';

export async function detectAI(params: AIDetectionParams): Promise<AIDetectionResult> {
  try {
