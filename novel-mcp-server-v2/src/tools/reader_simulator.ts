import type { ReaderSimulatorParams, ReaderSimulation } from '../types/index.js';

export async function simulateReader(params: ReaderSimulatorParams): Promise<ReaderSimulation> {
  try {
    ...
    const predicted_drop_points: number[] = [];
